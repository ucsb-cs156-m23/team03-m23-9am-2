...
describe("UCSBDiningCommonsMenuItemCreatePage tests", () => {
    ...
    test("on submit, makes request to backend, and redirects to /ucsbdiningcommonsmenuitem", async () => {
        ...
        fireEvent.change(diningCommonsCodeInput, { target: { value: 'DC1' } })
        fireEvent.change(nameInput, { target: { value: 'salad' } })
        fireEvent.change(stationInput, { target: { value: 'Vegan' } })
        ...
        expect(mockToast).toBeCalledWith("New menu item Created - id: 17 name: salad");
