...
public class HelpRequestControllerTests extends ControllerTestCase {
        ...
        public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
                ...
                HelpRequest helpRequest = HelpRequest.builder()
                                .requesterEmail("elfouly")
                                .teamId("02")
                                .tableOrBreakoutRoom("02")
                                .requestTime(ldt)
                                .explanation("dates are painful")
                                .solved(false)
                                .build();
        ...
        public void logged_in_user_can_get_all_helpRequests() throws Exception {
                ...
                HelpRequest helpRequest2 = HelpRequest.builder()
                                ...
                                .tableOrBreakoutRoom("02")
                                .requestTime(ldt2)
                                .explanation("dates are very painful")
                                .solved(false)
                                .build();
        ...
        public void an_admin_user_can_post_a_new_helpRequest() throws Exception {
                ...
                MvcResult response = mockMvc.perform(
                                post("/api/helprequests/post?requesterEmail=elfouly&teamId=01&tableOrBreakoutRoom=01&date=2022-01-03T00:00:00&explanation=dates&solved=true")
                                                .with(csrf()))
                                .andExpect(status().isOk()).andReturn();
        ...
        public void admin_can_edit_an_existing_helprequest() throws Exception {
                ...
                HelpRequest helpRequestEdited = HelpRequest.builder()
                                .requesterEmail("elfoulyEdited")
                                .teamId("02")
                                .tableOrBreakoutRoom("02")
                                .requestTime(ldt2)
                                .explanation("differentDates")
                                .solved(true)
                                .build();
